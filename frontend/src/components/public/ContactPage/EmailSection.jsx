      ...
      <div className="container mx-auto px-6 lg:px-16">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8">
          <div className="bg-blue-800 text-white p-6 rounded-lg shadow-lg w-full sm:w-80">
            ...
            <a href="mailto:sales@pintura.com" className="font-semibold">
              sales@pintura.com <i className="fas fa-arrow-right"></i>
            </a>
          </div>
          <div className="bg-white text-blue-800 p-6 rounded-lg shadow-lg w-full sm:w-80 border border-gray-200">
            ...
            <a href="mailto:partners@pintura.com" className="font-semibold">
              partners@pintura.com <i className="fas fa-arrow-right"></i>
            </a>
          </div>
          <div className="bg-white text-blue-800 p-6 rounded-lg shadow-lg w-full sm:w-80 border border-gray-200">
            <div className="text-4xl mb-4">
            ...
            <a href="mailto:help@pintura.com" className="font-semibold">
              help@pintura.com <i className="fas fa-arrow-right"></i>
            </a>
          </div>
        </div>
      </div>
